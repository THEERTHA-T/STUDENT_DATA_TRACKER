    ...
    <head>
        ...
        <link type="text/css" href='http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600'
          ...
          $.ajax({
                  ...
                  data:{'first_name' : $first_name, 'last_name' : $last_name, 'user_name' : $user_name,'user_type' : $user_type,'qualification' : $qualification,'dob' : $dob,'password':$password,'place' : $place,'phone_no':$phone_no,'email_id':$email_id,'college_name':$college_name},
                  dataType:"json",
                  type:"post",
