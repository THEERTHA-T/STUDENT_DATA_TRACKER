...
<head>
 ...
 <script >
          ...
          $.ajax({
                  url:"../CODE/add_event_code.php",
                  data:{'course_name' : $course_name,'sem' : $sem,'event_name' : $event_name,'stud_name' : $stud_name,'event_date' : $event_date,'position' : $position},
                  dataType:"json",
                  type:"post",
...
<body>
  <div class="navbar navbar-fixed-top">
                   ...
                   $sql="select * from event";
                    ...
                    ?>
                      ...
                      <div class="controls">
                       ...
                       &nbsp; &nbsp;  Event Name : <br>
                         &nbsp; &nbsp; <select tabindex="1" id="event_name"  class="span5">
    ...
    <div class="control-group">
                      ...
                      <div class="controls">
                      &nbsp; &nbsp;  Event Date :<br>
                       &nbsp; &nbsp; <input type="Date" id="event_date" placeholder="event date" class="span5">
                      </div>  
                    </div>
                       <div class="control-group">
                      <label class="control-label" for="basicinput"></label>
                      <div class="controls">
                    &nbsp; &nbsp;    Position :<br>                        
                        &nbsp; &nbsp; <select class="span5" id="position">
